...
- :globe_with_meridians: Development URL: https://dev.ms-customer-check.kapitalbank.az
- :globe_with_meridians: Preproduction URL: https://pre.ms-customer-check.kapitalbank.az
- :globe_with_meridians: Production URL: https://ms-customer-check.kapitalbank.az
## :question: ***How to Check Builds?***
- :sparkles: Jenkins URL: https://jenkins.kapitalbank.az/job/marketplace/job/ms-customer-check
